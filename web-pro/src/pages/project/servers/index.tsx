...
import { Button, Card, Col, Form, Input, Modal, Popconfirm, Row, Select, Space, Table, Tag, Tree, Typography, message } from "antd";
...
import {
  ...
  buildCloudTagsJSON,
  mapChargeTypeZh,
  mapNetworkChargeTypeZh,
  parseCloudTagRows,
  renderCloudTags,
  type CloudTagKV,
} from "@/utils/cloud-server-display";
import { ServerFormDrawer } from "../../project-servers/server-form-drawer";
...
export default function ProjectServersPage() {
  ...
  return (
    <PageContainer header={{ title: "服务器管理", subTitle: "自建与云服务器分组、同步与连接" }}>
    <Card bordered={false} style={{ height: "calc(100vh - 130px)" }} bodyStyle={{ height: "100%", paddingBottom: 12 }}>
      ...
      <ServerFormDrawer
        ...
        current={current}
        form={form}
        cloudTagRows={cloudTagRows}
        onCloudTagRowsChange={setCloudTagRows}
        options={{
          serverOsOptions,
          serverAuthOptions,
          activePortDict,
