...
import { SectionDivider } from "@/components/ops/section-divider";
...
export default function MysqlBackupPage() {
  return (
    <LegacyShell>
      <MysqlBackupPageInner />
    </LegacyShell>
  );
}

function MysqlBackupPageInner() {
  ...
  return (
    <PageContainer header={{ title: "MySQL 备份", subTitle: "复用项目 SSH 凭据归档至 MinIO" }}>
    <Card
