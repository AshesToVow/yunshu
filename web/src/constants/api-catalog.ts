...
export const API_CATALOG_GROUPS: { title: string; routes: ApiCatalogRow[] }[] = [
  ...
  },
  {
    ...
    routes: [
      ...
      { method: "GET", path: "/api/v1/projects/:id/change-events", summary: "变更事件列表", ui: "变更中心", auth: true },
      { method: "GET", path: "/api/v1/projects/:id/change-events/conflict-check", summary: "变更冲突/冻结检查", ui: "变更中心", auth: true },
      { method: "GET", path: "/api/v1/projects/:id/change-freeze-windows", summary: "冻结窗口列表", ui: "变更中心", auth: true },
      { method: "POST", path: "/api/v1/projects/:id/change-freeze-windows", summary: "保存冻结窗口", ui: "变更中心", auth: true },
      { method: "DELETE", path: "/api/v1/projects/:id/change-freeze-windows/:freezeId", summary: "删除冻结窗口", ui: "变更中心", auth: true },
      { method: "GET", path: "/api/v1/projects/:id/incident-context", summary: "故障上下文（近窗变更/发布）", ui: "故障工作台", auth: true },
      { method: "GET", path: "/api/v1/projects/:id/incidents", summary: "故障单列表", ui: "故障工作台", auth: true },
      { method: "POST", path: "/api/v1/projects/:id/incidents", summary: "开故障单", ui: "故障工作台", auth: true },
