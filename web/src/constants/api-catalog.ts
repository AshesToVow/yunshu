...
export const API_CATALOG_GROUPS: { title: string; routes: ApiCatalogRow[] }[] = [
  ...
  },
  {
    ...
    routes: [
      ...
      { method: "POST", path: "/api/v1/projects/:id/loggie/bootstrap", summary: "Loggie 引导登记", ui: "Loggie 状态", auth: true },
      { method: "GET", path: "/api/v1/projects/:id/loggie/status", summary: "Loggie 状态列表", ui: "Loggie 状态", auth: true },
      { method: "GET", path: "/api/v1/projects/:id/loggie/bootstrap-sources", summary: "引导日志源预览", ui: "Loggie 状态", auth: true },
      { method: "GET", path: "/api/v1/projects/:id/loggie/pipeline/download", summary: "下载 Loggie 配置", ui: "Loggie 状态", auth: true },
      { method: "POST", path: "/api/v1/projects/:id/loggie/deploy", summary: "SSH 下发 Loggie 配置", ui: "Loggie 状态", auth: true },
      { method: "POST", path: "/api/v1/projects/:id/loggie/restart", summary: "SSH 重启 Loggie", ui: "Loggie 状态", auth: true },
      { method: "POST", path: "/api/v1/projects/:id/loggie/sync", summary: "从日志源同步并下发", ui: "Loggie 状态", auth: true },
