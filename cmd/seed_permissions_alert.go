...
func seedPermissionsAlert() []model.Permission {
	return []model.Permission{
		...
		{Name: "告警转故障工单", Resource: "/api/v1/alerts/to-ticket", Action: "POST", Description: "Create incident ticket from alert event or fingerprint"},
		{Name: "告警事件转故障工单", Resource: "/api/v1/alerts/events/:alert_event_id/to-ticket", Action: "POST", Description: "Create incident ticket from alert delivery event"},
		...
		{Name: "告警数据源健康列表", Resource: "/api/v1/alerts/datasources/health", Action: "GET", Description: "List datasource health"},
		{Name: "告警数据源健康详情", Resource: "/api/v1/alerts/datasources/:id/health", Action: "GET", Description: "Get datasource health"},
		{Name: "告警数据源健康探测", Resource: "/api/v1/alerts/datasources/:id/health-check", Action: "POST", Description: "Check datasource health"},
