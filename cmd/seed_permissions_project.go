...
func seedPermissionsProject() []model.Permission {
	return []model.Permission{
		...
		{Name: "项目服务器只读探测", Resource: "/api/v1/projects/:id/servers/:serverId/probe", Action: "POST", Description: "SSH readonly host probe (disk/mem/load)"},
		...
		{Name: "项目变更时间线", Resource: "/api/v1/projects/:id/change-events", Action: "GET", Description: "List project change events timeline"},
